  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-100 text-gray-900">
      <header className="mx-auto max-w-5xl px-6 py-12 flex items-center justify-between">
        <div className="text-lg font-semibold">Toda la Informacion de la Jornada Laboral</div>
        ...
        <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600">
              Centraliza la asistencia, genera métricas de puntualidad y ofrece paneles diferenciados para empleados y administradores por medio de un codigo privado.
            </p>
            
            <ul className="grid gap-3 text-sm text-gray-700 sm:grid-cols-2">
              <li className="rounded-lg bg-white p-4 shadow-card border border-gray-100">De Manera Rapida Marcar entrada y salida con un clic.</li>
              <li className="rounded-lg bg-white p-4 shadow-card border border-gray-100">Histórico filtrable y exportable que contiene la informacion de tus Empleado.</li>
              <li className="rounded-lg bg-white p-4 shadow-card border border-gray-100">Panel administrado con métricas agregadas y estadistica.</li>
              <li className="rounded-lg bg-white p-4 shadow-card border border-gray-100">Autenticación Unica con roles (admin/empleado).</li>
            </ul>
          </div>
